...
export const MOCK_TEAMS = [
  {
    ...
    submission: {
      ...
      description: 'An autonomous agent orchestration tool that monitors live build pipelines.',
  ...
  },
  {
    ...
    submission: {
      ...
      description: 'Distributed WebSocket telemetry hub designed for live venues.',
